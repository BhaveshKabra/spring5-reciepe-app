package org.bhavesh.bootloader;
...
import org.bhavesh.model.Difficulty;
import org.bhavesh.model.Ingredient;
import org.bhavesh.model.Notes;
import org.bhavesh.model.Recipe;
import org.bhavesh.model.UnitOfMeasure;
import org.bhavesh.repository.CategoryRepository;
import org.bhavesh.repository.IngredientRepository;
import org.bhavesh.repository.RecipeRepoistory;
import org.bhavesh.repository.UnitOfMeasureRepoistory;
...
public class Dataloader implements ApplicationListener<ContextRefreshedEvent> {
	...
	private final UnitOfMeasureRepoistory uomRepoistory;
	private final IngredientRepository ingredientRepository;
	private final CategoryRepository categoryRepository;
	public Dataloader(RecipeRepoistory recipeRepoistory,UnitOfMeasureRepoistory uomrepo,IngredientRepository ingredientRepository,CategoryRepository categoryRepository)
	{
		this.recipeRepoistory=recipeRepoistory;
		this.uomRepoistory=uomrepo;
	...
	private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasure> eachUomOptional = uomRepoistory.findByDescription("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional = uomRepoistory.findByDescription("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional = uomRepoistory.findByDescription("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptional = uomRepoistory.findByDescription("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = uomRepoistory.findByDescription("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = uomRepoistory.findByDescription("Cup");
